...
// set date box
dateBox.textContent = ['Sunday','Monday','Tuesday','Wednesday','Thursday','Friday','Saturday'][new Date().getDay()]+', '+monthDayYear(new Date());
  ...
  function updateCurrent() {
    ...
    if (periodIndex === undefined) { // if no school day /  after school
      ...
      while (true) {
        ...
        console.log(previousMondayDate)
