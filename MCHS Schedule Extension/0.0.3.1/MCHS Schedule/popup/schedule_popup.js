// const bellOffsetFile = fetch('https://raw.githubusercontent.com/silasiscool/MCHS_Schedule/main/bell_offset.json?nocache='+(Math.random()+'').replace('.','')).then(res => res.json());
